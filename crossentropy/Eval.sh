#!/bin/bash
cd ${PBS_O_WORKDIR}
#t2sub -q S -l select=1:ncpus=8:mem=30gb ./Eval.sh
if [ -r ap.csv ] ;then
rm ap.csv
fi
#dir=$1
#dir=MED14/batch5_hiddensize64_train6988_soft_initialized_t1_lr0.01/
dir=MED14/batch5_hiddensize256_train6988_hard_initialized_t1_lr0.01/
testtype="med14test"
