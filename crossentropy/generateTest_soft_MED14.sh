...
function generate() {
	...
	#test shell
	testfile="jobTest_h${HIDDEN_NUM}_${TRAIN_SAMPLE_NUM}_${TYPE1}${TYPE2}_t${TEMPRATURE}${TYPE3}_MED14.sh"
	touch $testfile && chmod +x $testfile
	logtest=logTest_h${HIDDEN_NUM}_${TRAIN_SAMPLE_NUM}_${TYPE1}${TYPE2}_t${TEMPRATURE}${TYPE3}_MED14
