...
def draw(type,hidden,t,x_e,lr):
	#inpath="batch5_hiddensize%d_train6988_%s_initialized_t%d" %(hidden,type,t)
	inpath="."
	inputfile_t="%s/logTrain_h%d_6988_%s_initialized_t%d" %(inpath,hidden,type,t)
        imgname='%s_hidden%d_temperature%d.png' %(type,hidden,t)
        plttitle='%s_hidden%d_temperature%d' %(type,hidden,t)
