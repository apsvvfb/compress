...
function generate() {
	...
	mainpath=${mainpath}_${TYPE1}${TYPE2}_t${TEMPRATURE}_lr${LEARNING_RATE}
	...
	#train shell
        trainfile="jobTrain_h${HIDDEN_NUM}_${TRAIN_SAMPLE_NUM}_${TYPE1}${TYPE2}_t${TEMPRATURE}_lr${LEARNING_RATE}.sh"
        touch $trainfile && chmod +x $trainfile
	logtrain=logTrain_h${HIDDEN_NUM}_${TRAIN_SAMPLE_NUM}_${TYPE1}${TYPE2}_t${TEMPRATURE}_lr${LEARNING_RATE}
	...
	#test shell
	testfile="jobTest_h${HIDDEN_NUM}_${TRAIN_SAMPLE_NUM}_${TYPE1}${TYPE2}_t${TEMPRATURE}_lr${LEARNING_RATE}.sh"
	touch $testfile && chmod +x $testfile
	logtest=logTest_h${HIDDEN_NUM}_${TRAIN_SAMPLE_NUM}_${TYPE1}${TYPE2}_t${TEMPRATURE}_lr${LEARNING_RATE}
